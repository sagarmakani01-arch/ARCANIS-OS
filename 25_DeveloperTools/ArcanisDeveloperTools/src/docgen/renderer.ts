import { DocumentationPage, DocumentedSymbol } from './types.js';
...
${symbolsHtml}
  ...
  private renderSymbols(symbols: DocumentedSymbol[], indent: number): string[] {
    const lines: string[] = [];
  ...
  private symbolToHtml(sym: DocumentedSymbol, depth: number): string {
